 ...
 * </p>
 * <p>
 * Originally Copied from: http://grepcode.com/file_/repo1.maven.org/maven2/com.google.http-client/google-http-client/1.20.0/com/google/api/client/util/DateTime.java
 *
 * @author Yaniv Inbar
 * @since 1.0
 */
public final class RFC3339DateTime implements Serializable {
    ...
    /**
     * Instantiates {@link com.jiahan.fave.core.utils.RFC3339DateTime} from a {@link Date} and {@link TimeZone}.
     *
     * @param date date and time
     * @param zone time zone; if {@code null}, it is interpreted as {@code TimeZone.getDefault()}.
     */
    public RFC3339DateTime(Date date, TimeZone zone) {
        this(false, date.getTime(), zone == null ? null : zone.getOffset(date.getTime()) / 60000);
    }

    /**
     * Instantiates {@link com.jiahan.fave.core.utils.RFC3339DateTime} from the number of milliseconds since the Unix epoch.
     * <p>
     * <p>
     ...
     */
    public RFC3339DateTime(long value) {
        this(false, value, null);
    }

    /**
     * Instantiates {@link com.jiahan.fave.core.utils.RFC3339DateTime} from a {@link Date}.
     * <p>
     * <p>
     * The time zone is interpreted as {@code TimeZone.getDefault()}, which may vary with
     * implementation.
     ...
     */
    public RFC3339DateTime(Date value) {
        this(value.getTime());
    }

    /**
     * Instantiates {@link com.jiahan.fave.core.utils.RFC3339DateTime} from the number of milliseconds since the Unix epoch, and a shift
     * from UTC in minutes.
     *
     * @param value   number of milliseconds since the Unix epoch (January 1, 1970, 00:00:00 GMT)
     * @param tzShift time zone, represented by the number of minutes off of UTC.
     */
    public RFC3339DateTime(long value, int tzShift) {
        this(false, value, tzShift);
    }

    /**
     * Instantiates {@link com.jiahan.fave.core.utils.RFC3339DateTime}, which may represent a date-only value, from the number of
     ...
     */
    public RFC3339DateTime(boolean dateOnly, long value, Integer tzShift) {
    ...
    /**
     * Instantiates {@link com.jiahan.fave.core.utils.RFC3339DateTime} from an <a href='http://tools.ietf.org/html/rfc3339'>RFC 3339</a>
     * date/time value.
     * <p>
     * <p>
     ...
     * @since 1.11
     */
    public RFC3339DateTime(String value) {
        ...
        com.jiahan.fave.core.utils.RFC3339DateTime dateTime = parseRfc3339(value);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.jiahan.fave.core.utils.RFC3339DateTime)) {
            return false;
        }
        com.jiahan.fave.core.utils.RFC3339DateTime other = (com.jiahan.fave.core.utils.RFC3339DateTime) o;
     ...
     */
    public static com.jiahan.fave.core.utils.RFC3339DateTime parseRfc3339(String str) throws NumberFormatException {
        ...
        return new com.jiahan.fave.core.utils.RFC3339DateTime(!isTimeGiven, value, tzShiftInteger);
    }
